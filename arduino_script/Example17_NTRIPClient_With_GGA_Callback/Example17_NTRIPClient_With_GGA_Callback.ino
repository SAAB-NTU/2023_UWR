...
ros::Publisher gps_rtk("gps_rtk", &gps_msg);
...
void printPVTdata(UBX_NAV_PVT_data_t *ubxDataStruct)
{
  ...
  gps_msg.latitude=latitude / 10000000.0;
  gps_msg.longitude=longitude/10000000.0;
  gps_msg.altitude=altitude/1000.0;
  if(carrSoln>0)
  {
