...
class DiscreteKalmanFilter:public KalmanFilter_6dof
{
    ...
    private: 
        ...
        //To start filtering
        bool start = true,bias_taken=false;
    ...
    public:
        ...
        DiscreteKalmanFilter():KalmanFilter_6dof()
        {
            ...
            //sonar_sub = nh_.subscribe("/sonar_3",1,&DiscreteKalmanFilter::sonar_callback,this);
    ...
    //ros::Time time = ros::Time::now();
        ...
        void sonar_callback(const sonar::ThreeSonarDepthConstPtr& msg)  //Can substitute with Measurement Callback
        {
            ...
            {
            ros::Time time = ros::Time::now();
            float distance_x = sonar_filter_x.MovingAvg(msg->distance_2/1000);
            //Based on IMU position
            float distance_y = sonar_filter_y.MovingAvg(msg->depth);
            float distance_z = sonar_filter_z.MovingAvg(msg->distance_1/1000);
