...
set(MSG_I_FLAGS "-Ilogger:/home/saab/Desktop/marus_sim/ros_ws/src/Rpi_logger_v2/src/logger/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/saab/Desktop/marus_sim/ros_ws/src/Rpi_logger_v2/src/logger/msg/Motor.msg" NAME_WE)
add_custom_target(_logger_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "logger" "/home/saab/Desktop/marus_sim/ros_ws/src/Rpi_logger_v2/src/logger/msg/Motor.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(logger
  "/home/saab/Desktop/marus_sim/ros_ws/src/Rpi_logger_v2/src/logger/msg/Motor.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/logger)
  install(CODE "execute_process(COMMAND \"/home/saab/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/logger\")")
  # install generated code
  install(
